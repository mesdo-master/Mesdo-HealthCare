...
const updateUserInfo = async (req, res) => {
  try {
    ...
    console.log("updateUserInfo - updatedProfile:", updatedProfile);
    ...
    console.log("updateUserInfo - transformedProfile:", transformedProfile);
    ...
    if (prevPublicId) {
      try {
        ...
        if (destroyResult.result !== "ok") {
          console.warn(
            "Previous profile picture deletion warning:",
            destroyResult
          );
        }
