                  ...
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center gap-2 ml-4">
                      <select
                        ...
                        className="border border-gray-300 rounded-md px-3 py-2 text-gray-700 bg-white text-sm font-medium"
                      >
                      ...
                      <button
                        onClick={handleSort}
                        className="border border-gray-300 rounded-md px-3 py-2 text-gray-700 bg-white flex items-center gap-1 text-sm font-medium"
                      >
                        Sort
                      </button>
                    </div>
                      ...
                      {applicants && applicants.length > 0 ? (
                        ...
                        <div className="text-center py-16">
                          ...
                          <p className="text-gray-600">
                            No one has applied to this job yet. Share the job
