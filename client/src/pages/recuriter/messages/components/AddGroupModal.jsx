    ...
    <div className="fixed inset-0 backdrop-blur-sm bg-black/30 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-xl w-full max-w-4xl max-h-[90vh] flex shadow-lg overflow-hidden">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="px-6 mb-4">
            <button
              className="w-full bg-blue-500 hover:bg-blue-600 text-white rounded-lg py-3 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={selectedCount < 2}
            >
              <UserPlus size={20} />
              Add {selectedCount < 2 ? 2 : selectedCount} Members
            </button>
          </div>
