            ...
            <img
              src={
                isGroupChat
                  ...
                  : selectedUser?.profilePicture || conversation?.otherParticipant?.orgLogo || piimage
              }
              alt={isGroupChat ? conversation?.name : selectedUser?.name}
          ...
          <div className="ml-3">
            <h2 className="font-semibold text-base">
              {isGroupChat
                ...
                : selectedUser?.name || conversation?.otherParticipant?.name}
            </h2>
